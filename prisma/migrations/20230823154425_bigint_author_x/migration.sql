/*
  ...
  - You are about to alter the column `id` on the `Author` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `author_id` on the `Tweet` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `author_id` on the `Like` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `author_id` on the `Retweet` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `follower_id` on the `Follow` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `following_id` on the `Follow` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
